...
public class DangKyFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (kiemTraKhongRong()) {
            ...
            String name = jTextFieldHoVaTen.getText();
            String diaChi = jTextFieldDiaChi.getText();
            int sdt = Integer.parseInt(jTextFieldSDT.getText());
            String email = jTextFieldEmail.getText();
            String matKhau = String.valueOf(jPasswordFieldMK.getPassword().toString());
            Date ngaySinh = jDateChooserNgaySinh.getDate();
            Date ngayDangKy = jDateChooserNgayDangKy.getDate();
            if (!khDAO.kiemTraEmailTonTai(email)) {
